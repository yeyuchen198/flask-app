...
def runService():
  print(subprocess.call(("/tmp/uwsgi/bin/uwsgi -config /tmp/uwsgi/bin/uwsgi.json"), shell=True))
...
shutil.copy('uwsgi.json', '/tmp/uwsgi/bin/uwsgi.json')
print('---copy uwsgi.json successs.---')
print('---run uWSGI service---')
# print(subprocess.call(("./uwsgi -config=./uwsgi.json"), shell=True))
# print(subprocess.call(("/tmp/uwsgi/bin/uwsgi -config /tmp/uwsgi/bin/uwsgi.json"), shell=True))
runService()
